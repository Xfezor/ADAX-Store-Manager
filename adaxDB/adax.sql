...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-09-2024 a las 23:59:07
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `RecuperarContrasenaUsuario2` (IN `p_correo` VARCHAR(100))   BEGIN
...
-- Funciones
--
CREATE DEFINER=`root`@`localhost` FUNCTION `desencriptarClave` (`docu` INT) RETURNS VARCHAR(50) CHARSET utf8mb4 COLLATE utf8mb4_general_ci  BEGIN
...
CREATE DEFINER=`root`@`localhost` FUNCTION `desencriptarClaveCorreo` (`email` VARCHAR(45)) RETURNS VARCHAR(50) CHARSET utf8mb4 COLLATE utf8mb4_general_ci  BEGIN
declare contrasenaDesencriptada varchar(45);
select aes_decrypt(contrasena, "adaxdecripter2024") into contrasenaDesencriptada from usuarios where correo = email;
RETURN contrasenaDesencriptada;
END$$

CREATE DEFINER=`root`@`localhost` FUNCTION `desencriptarClaveCorreoTienda` (`email` VARCHAR(45)) RETURNS VARCHAR(50) CHARSET utf8mb4 COLLATE utf8mb4_general_ci  BEGIN
declare contrasenaDesencriptada varchar(45);
select aes_decrypt(contrasena, "adaxdecripter2024") into contrasenaDesencriptada from tienda where correo = email;
RETURN contrasenaDesencriptada;
END$$

CREATE DEFINER=`root`@`localhost` FUNCTION `desencriptarClaveTienda` (`docu` INT) RETURNS VARCHAR(50) CHARSET utf8mb4 COLLATE utf8mb4_general_ci  BEGIN
declare contrasenaDesencriptada varchar(45);
...
(50, 'OLG', 500, '', '', '', NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `tienda` (
  ...
  `codigo_invitacion` int(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tienda` (`idtienda`, `nombreTienda`, `direccion`, `telefono`, `correo`, `documento`, `tipo_documento`, `contrasena`, `codigo_invitacion`) VALUES
(1, 'Supermercado El Barrio', 'Cra 45 # 19-12', 3157894560, 'contacto@elbarrio.com', 0, '0', '', 92),
(2, 'ElectroShop Bogotá', 'Av. Boyacá # 71-45', 3123456789, 'info@electroshopbogota.com', 0, '0', '', 93),
(3, 'Librería El Saber', 'Calle 72 # 6-14', 3145678901, 'ventas@libreriaelsaber.com', 0, '0', '', 94),
(4, 'Farmacia La Salud', 'Carrera 15 # 101-34', 3178901234, 'atencion@farmacialasalud.com', 0, '0', '', 95),
(5, 'Moda y Estilo', 'Calle 85 # 10-20', 3189012345, 'info@modayestilo.com', 0, '0', '', 96),
(6, 'Deportes y Más', 'Calle 53 # 21-12', 3190123456, 'contacto@deportesymas.com', 0, '0', '', 97),
(7, 'Tienda de Abarrotes La Familia', 'Cra 19 # 32-15', 3201234567, 'ventas@tiendafamilia.com', 0, '0', '', 98),
(8, 'Muebles y Decoración', 'Av. Jiménez # 5-60', 3212345678, 'info@mueblesdecoracion.com', 0, '0', '', 99),
(9, 'Juguetería Divertida', 'Cra 10 # 22-30', 3223456789, 'contacto@jugueteriadivertida.com', 0, '0', '', 100),
(10, 'Panadería El Trigo', 'Calle 50 # 8-90', 3234567890, 'info@panaderiaeltrigo.com', 0, '0', '', 101),
(11, 'Café Gourmet', 'Cra 9 # 45-67', 3245678901, 'contacto@cafegourmet.com', 0, '0', '', 102),
(12, 'Ropa y Moda', 'Av. Caracas # 48-20', 3256789012, 'info@ropaymoda.com', 0, '0', '', 103),
(13, 'Tecnología al Día', 'Calle 26 # 11-25', 3267890123, 'ventas@tecnologiaaldia.com', 0, '0', '', 104),
(14, 'Lácteos y Más', 'Cra 7 # 10-45', 3278901234, 'info@lacteosymas.com', 0, '0', '', 105),
(15, 'Tienda de Vinos', 'Calle 94 # 17-30', 3289012345, 'contacto@tiendadevinos.com', 0, '0', '', 106),
(16, 'Zapatería El Paso', 'Cra 22 # 5-90', 3290123456, 'info@zapateriaalpaso.com', 0, '0', '', 107),
(17, 'Delicatessen Gourmet', 'Calle 55 # 12-65', 3301234567, 'ventas@delicatessengourmet.com', 0, '0', '', 108),
(18, 'Electrodomésticos Centro', 'Av. El Dorado # 20-40', 3312345678, 'contacto@electrodomesticoscentro.com', 0, '0', '', 109),
(19, 'Floristería Elegante', 'Cra 3 # 21-75', 3323456789, 'info@floristeriaelegante.com', 0, '0', '', 110),
(20, 'Tienda de Deportes', 'Calle 17 # 3-60', 3334567890, 'contacto@tiendadeportes.com', 0, '0', '', 111),
(21, 'Pastelería La Dulce Vida', 'Cra 12 # 45-89', 3345678901, 'info@pastelerialadulcevida.com', 0, '0', '', 112),
(22, 'Centro de Belleza', 'Av. Chile # 25-40', 3356789012, 'contacto@centrobelleza.com', 0, '0', '', 113),
(23, 'Muebles Modernos', 'Calle 8 # 18-90', 3367890123, 'ventas@mueblesmodernos.com', 0, '0', '', 114),
(24, 'Juguetes para Todos', 'Cra 11 # 25-15', 3378901234, 'info@juguetesparatodos.com', 0, '0', '', 115),
(25, 'Farmacia San Juan', 'Calle 77 # 5-20', 3389012345, 'atencion@farmaciasanjuan.com', 0, '0', '', 116),
(26, 'Perfumería y Cosméticos', 'Cra 16 # 30-45', 3390123456, 'info@perfumeriaycosmeticos.com', 0, '0', '', 117),
(27, 'Tiendas El Ahorro', 'Calle 32 # 22-90', 3401234567, 'contacto@tiendaselahorro.com', 0, '0', '', 118),
(28, 'Tienda de Tecnología', 'Av. San Martín # 50-60', 3412345678, 'ventas@tiendatecnologia.com', 0, '0', '', 119),
(29, 'Librería y Papelería', 'Cra 8 # 15-70', 3423456789, 'info@libreriaypapeleria.com', 0, '0', '', 120),
(30, 'Ropa y Calzado', 'Calle 46 # 22-80', 3434567890, 'contacto@ropaycalzado.com', 0, '0', '', 121),
(80, 'Margaritas', 'calle 32', 123412, 'tienda@gmail.com', 10148648, '0', 0xdd82284af317e23fccef155fd6a6d9a5, 122),
(90, 'Los rosales', 'calle 6a', 3156782834, 'losrosalestienda@gmail.com', 2147483647, 'CC', 0xa90e556a490f00d775c8aa3030760c47, 123),
(91, 'Polleria 22', 'calle 82a', 317462345, 'pollosla22@gmail.com', 100157863, 'CC', 0x89877865cae2ca39bb5d79186bdded74, 124);
...
INSERT INTO `usuarios` (`documento`, `tipo_doc`, `contrasena`, `nombre1`, `nombre2`, `apellido1`, `apellido2`, `correo`, `rol_id_Rol`, `codigo_invitacion`) VALUES
(1, 'CC', 0x4902a6142e71173d952de35554ed0db0, 'da', '', 'da', '', 'da@gmail.com', 2, 123),
(1001331, 'CC', 0xe0138ac8400b4a3232fee1db9bc211d5, 'javier', '', 'lopez', '', 'javier23@gmail.com', 2, 0),
(10108890, 'CC', '', 'Santiago', '', 'Martinez', '', 'matinotes95@gmail.com', 1, 0),
(101088908, 'CC', 0xcf0f81b722021640a2a4eada70832a53, 'Santiago', '', 'Martinez', '', 'matinotes95@gmail.com', 1, 0),
(1000123456, 'CC', '', 'Juan', 'Pablo', 'Gonzalez', 'Martinez', 'juan.gonzalez@example.com', 1, 0),
(1000234567, 'CC', '', 'Maria', 'Fernanda', 'Lopez', 'Castro', 'maria.lopez@example.com', 2, 0),
(1000345678, 'CC', '', 'Andres', 'Felipe', 'Rodriguez', 'Sierra', 'andres.rodriguez@example.com', 3, 0),
(1000456789, 'CC', '', 'Laura', 'Isabel', 'Hernandez', 'Martinez', 'laura.hernandez@example.com', 1, 0),
(1000567890, 'CC', '', 'Carlos', 'Andres', 'Mendoza', 'Valencia', 'carlos.mendoza@example.com', 2, 0),
(1000678901, 'CC', '', 'Valentina', 'Paredes', 'Cruz', 'García', 'valentina.paredes@example.com', 3, 0),
(1000789012, 'CC', '', 'Sebastian', 'Gonzalez', 'Ardila', 'Ospina', 'sebastian.gonzalez@example.com', 1, 0),
(1000890123, 'CC', '', 'Catalina', 'Cruz', 'Cardenas', 'Rodriguez', 'catalina.cruz@example.com', 2, 0),
(1000901234, 'CC', '', 'Nicolas', 'Sanchez', 'Henao', 'Rivas', 'nicolas.sanchez@example.com', 3, 0),
(1001012345, 'CC', '', 'Sofia', 'Torres', 'Morales', 'Suárez', 'sofia.torres@example.com', 1, 0),
(1001123456, 'CC', '', 'Daniela', 'Ramirez', 'Cano', 'Loaiza', 'daniela.ramirez@example.com', 2, 0),
(1001234567, 'CC', '', 'Alejandro', 'Hernandez', 'Mora', 'Hurtado', 'alejandro.hernandez@example.com', 3, 0),
(1001345678, 'CC', '', 'Isabella', 'Mendoza', 'Pérez', 'Orjuela', 'isabella.mendoza@example.com', 1, 0),
(1001456789, 'CC', '', 'Jorge', 'Martinez', 'Gómez', 'Méndez', 'jorge.martinez@example.com', 2, 0),
(1001567890, 'CC', '', 'Camila', 'Guerra', 'Patiño', 'García', 'camila.guerra@example.com', 3, 0),
(1001678901, 'CC', '', 'Felipe', 'Castro', 'Bermudez', 'García', 'felipe.castro@example.com', 1, 0),
(1001789012, 'CC', '', 'Mariana', 'Pineda', 'Pineda', 'Arboleda', 'mariana.pineda@example.com', 2, 0),
(1001890123, 'CC', '', 'David', 'Gomez', 'Arias', 'Correa', 'david.gomez@example.com', 3, 0),
(1001901234, 'CC', '', 'Juliana', 'Ospina', 'Bermudez', 'Jaramillo', 'juliana.ospina@example.com', 1, 0),
(1002012345, 'CC', '', 'Mateo', 'Guerrero', 'Reyes', 'Patiño', 'mateo.guerrero@example.com', 2, 0),
(1002123456, 'CC', '', 'Valeria', 'Rojas', 'Martinez', 'Vargas', 'valeria.rojas@example.com', 3, 0),
(1002234567, 'CC', '', 'Lucas', 'Vega', 'Ospina', 'Castro', 'lucas.vega@example.com', 1, 0),
(1002345678, 'CC', '', 'Natalia', 'Cano', 'Guzmán', 'García', 'natalia.cano@example.com', 2, 0),
(1002456789, 'CC', '', 'Juanita', 'Jaramillo', 'Mendoza', 'Ardila', 'juanita.jaramillo@example.com', 3, 0),
(1002567890, 'CC', '', 'Mateo', 'Vargas', 'Pineda', 'Cano', 'mateo.vargas@example.com', 1, 0),
(1002678901, 'CC', '', 'Emilia', 'Cordero', 'Gómez', 'Cano', 'emilia.cordero@example.com', 2, 0),
(1002789012, 'CC', '', 'Samir', 'Alvarez', 'Rincón', 'Mora', 'samir.alvarez@example.com', 3, 0),
(1002793012, 'CC', 0x07e30c56839766dd63ed2b59b7e3999e, 'Emilia', 'Gomez ', 'Rincón', 'Mora', 'emilia.gomez@example.com', 2, 0),
(1002890123, 'CC', '', 'Paola', 'Martinez', 'Patiño', 'Ospina', 'paola.martinez@example.com', 1, 0),
(1002901234, 'CC', '', 'Julián', 'Rincón', 'Guzmán', 'Rivas', 'julian.rincon@example.com', 2, 0),
(1003012345, 'CC', '', 'Diana', 'Uribe', 'Salazar', 'Sánchez', 'diana.uribe@example.com', 3, 0),
(1003123456, 'CC', '', 'Felipe', 'Ortega', 'Arce', 'García', 'felipe.ortega@example.com', 1, 0),
(1003234567, 'CC', '', 'Carolina', 'Sierra', 'López', 'Castaño', 'carolina.sierra@example.com', 2, 0),
(1003345678, 'CC', '', 'Sebastián', 'Martínez', 'Ospina', 'Méndez', 'sebastian.martinez@example.com', 3, 0),
(1021674963, 'CC', 0x07e30c56839766dd63ed2b59b7e3999e, 'Evelyn', 'Stephanie', 'Giraldo', 'Torres', 'evelyngt2020@gmail.com', 2, 0);
...
ALTER TABLE `tienda`
  ...
  ADD UNIQUE KEY `codigo_invitacion_UNIQUE` (`codigo_invitacion`);
...
--
ALTER TABLE `tienda`
  MODIFY `codigo_invitacion` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
