...
<body>
    <div class="contenedor">
        <form class="form" action="../login/procesologincrud.php" method="POST">
            <h1>ADAX - CRUD</h1>
            <span class="input-span">
                <label for="email" class="label">Tipo usuario</label>
                <select name="tipo">
                    <option default value="usuario">Usuario</option>
            ...
            <span class="input-span">
                ...
                <input type="password" name="contrasena" id="password" /></span>
