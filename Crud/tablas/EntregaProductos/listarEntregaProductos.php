        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button"
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">entregaproductos</a>
                        <ul class="dropdown-menu">
                ...
                <span class="navbar-text me-3 active">EntregaProductos:
                    <?php
    ...
    <table id="usrtable" class="table table-container table-striped table-hover table-bordered table-responsive mt-4 table-sm">
        ...
        <tbody>
            ...
            foreach ($allUsers as $user) { ?>
                <tr class="text-center">
                    <td><?php echo $user['proveedor_idproveedor']; ?></td>
                    <td><?php echo $user['producto_id_Producto']; ?></td>
                    <td><?php echo $user['fecha_Entrega']; ?></td>
                    <td><?php echo $user['cantidad']; ?></td>
                    <td>
                        <form action="actualizar.php" method="post">
                            <input type="hidden" name="doc" value="<?php echo $user['proveedor_idproveedor']; ?>">
                            <button type="submit" class="btn btn-warning">Modificar</button>
                        </form>
                    </td>
                    <td><a class="btn btn-danger" href="../../controlador/controlador.EntregaProductos.php?proveedor_idproveedor=<?php echo $user['proveedor_idproveedor']; ?>
