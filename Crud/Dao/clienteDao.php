...
class clienteDao{
    ...
    public function registrarCliente(clienteDto $clienteDto){ 
        ...
        try {
            $query = $conn->prepare("UPDATE cliente SET id_Cliente=?, Documento=?, Nombre1_Cliente=?, Nombre2_Cliente=?, Apellido1_Cliente=?, Apellido2_Cliente=?, Tipo_documento=? WHERE id_Cliente=?");
