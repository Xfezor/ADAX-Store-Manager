...
const GestionarProductos = () => {
  ...
  const Lista = useCallback(async () => {
    try {
      const respuesta = await axios.get(`${protocol}://${ip}:${port}/adx/ADAX-Store-Manager/Crud/controlador/controlador.producto.php?listarProductosApp=true&codigo_invitacion=${codigo_invitacion} `);
      if (respuesta.data) {
