...
CREATE TABLE `producto` (
  ...
  KEY `fk_producto_IdProveedor_idx` (`idProveedor`),
...
INSERT INTO `producto` VALUES (2,'Smartphone Samsung Galaxy',750,'Smartphone con cÃ¡mara de 64MP','Samsung','ElectrÃ³nica','Unidad','2025-10-30',100,20,1,3,3),(3,'Televisor LG OLED',1200,'Televisor con pantalla OLED de 55 pulgadas','LG','ElectrÃ³nica','Unidad','2025-11-15',30,5,0,3,1),(4,'Refrigerador Samsung',800,'Refrigerador de 500 litros','Samsung','ElectrodomÃ©stico','Unidad','2026-03-10',40,8,1,3,3),(5,'Aspiradora Rowenta',150,'Aspiradora de 1500W con bolsa','Rowenta','ElectrodomÃ©stico','Unidad','2025-07-22',60,15,1,3,4),(6,'Cafetera Philips',80,'Cafetera de 12 tazas','Philips','ElectrodomÃ©stico','Unidad','2025-05-30',75,20,1,3,2),(7,'CÃ¡mara Canon EOS',600,'CÃ¡mara rÃ©flex digital con lente de 18-55mm','Canon','ElectrÃ³nica','Unidad','2025-09-01',25,5,1,3,1),(8,'Microwave Panasonic',120,'Microondas de 20 litros','Panasonic','ElectrodomÃ©stico','Unidad','2025-06-15',90,10,1,3,3),(9,'Plancha T-fal',50,'Plancha de vapor antiadherente','T-fal','ElectrodomÃ©stico','Unidad','2024-12-31',85,10,1,3,5),(10,'Air Fryer Philips',180,'Freidora de aire de 1.8 litros','Philips','ElectrodomÃ©stico','Unidad','2025-01-20',70,15,1,3,4),(11,'Teclado Logitech',40,'Teclado mecÃ¡nico con retroiluminaciÃ³n','Logitech','ElectrÃ³nica','Unidad','2025-04-10',95,25,1,11,1),(12,'RatÃ³n Logitech',30,'RatÃ³n inalÃ¡mbrico con baterÃ­a recargable','Logitech','ElectrÃ³nica','Unidad','2025-02-28',100,30,1,12,4),(13,'Silla Gamer DXRacer',350,'Silla ergonÃ³mica para gaming','DXRacer','Muebles','Unidad','2025-08-15',20,5,1,13,3),(14,'Escritorio de Madera',200,'Escritorio de madera de 120x60 cm','MarcaEjemplo','Muebles','Unidad','2025-11-30',35,10,1,14,2),(15,'Auriculares Sony WH-1000XM4',300,'Auriculares inalÃ¡mbricos con cancelaciÃ³n de ruido','Sony','ElectrÃ³nica','Unidad','2025-12-01',45,10,1,15,5),(16,'Impresora HP DeskJet',100,'Impresora a color multifunciÃ³n','HP','ElectrÃ³nica','Unidad','2025-07-10',55,15,1,16,2),(17,'Teclado Gaming Corsair',80,'Teclado mecÃ¡nico RGB para gaming','Corsair','ElectrÃ³nica','Unidad','2025-09-05',60,20,1,17,1),(18,'Monitor Acer 24 pulgadas',220,'Monitor Full HD de 24 pulgadas','Acer','ElectrÃ³nica','Unidad','2025-10-20',50,10,1,18,NULL),(19,'BaterÃ­a externa Anker',45,'BaterÃ­a externa de 10000mAh','Anker','ElectrÃ³nica','Unidad','2025-03-15',80,25,1,19,NULL),(20,'Tablet Samsung Galaxy Tab',350,'Tablet con pantalla de 10.4 pulgadas','Samsung','ElectrÃ³nica','Unidad','2025-06-01',30,8,1,20,NULL),(21,'Silla de Oficina Ergohuman',400,'Silla ergonÃ³mica con ajuste lumbar','Ergohuman','Muebles','Unidad','2025-08-10',25,5,1,21,NULL),(22,'LÃ¡mpara LED Philips',60,'LÃ¡mpara LED regulable','Philips','ElectrodomÃ©stico','Unidad','2025-04-15',70,12,1,22,NULL),(23,'Barra de sonido JBL',150,'Barra de sonido con Bluetooth','JBL','ElectrÃ³nica','Unidad','2025-09-30',40,10,1,23,NULL),(24,'Estufa a gas Teka',180,'Estufa a gas de 4 quemadores','Teka','ElectrodomÃ©stico','Unidad','2025-12-15',35,7,1,24,NULL),(26,'SartÃ©n T-fal',70,'SartÃ©n antiadherente de 30 cm','T-fal','ElectrodomÃ©stico','Unidad','2025-05-01',85,15,1,26,NULL),(27,'Cuchillos de Cocina Zwilling',90,'Juego de cuchillos de acero inoxidable','Zwilling','ElectrodomÃ©stico','Juego','2025-11-20',55,10,1,27,NULL),(28,'Reloj Garmin Forerunner',200,'Reloj deportivo con GPS','Garmin','ElectrÃ³nica','Unidad','2025-07-25',30,8,1,28,NULL),(29,'Caja de herramientas Stanley',120,'Caja de herramientas con 100 piezas','Stanley','Herramientas','Unidad','2025-10-01',40,10,1,29,NULL),(30,'Ventilador Orbegozo',90,'Ventilador de pie con 3 velocidades','Orbegozo','ElectrodomÃ©stico','Unidad','2025-08-01',50,12,1,30,NULL),(31,'papaya',123,NULL,'',NULL,'','0000-00-00',123,0,1,3,NULL),(39,'Libro de arboles ancianos',10000,NULL,'',NULL,'','0000-00-00',5,0,1,3,NULL);
...
INSERT INTO `rol` VALUES (1,'Administrador','Acceso completo a todas las funciones del sistema'),(2,'Empleado','Acceso limitado a las funciones operativas'),(3,'DueÃ±o','Acceso total a su tienda');
...
BEGIN
    ...
    WHILE EXISTS (SELECT 1 FROM tienda WHERE codigo_invitacion = NEW.codigo_invitacion) DO
        SET NEW.codigo_invitacion = NEW.codigo_invitacion + 1; -- Incrementa hasta que sea Ãºnico
    END WHILE;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
BEGIN
    ...
    IF v_contrasena IS NOT NULL THEN
        SELECT CONCAT('La contraseÃ±a para el correo ', p_correo, ' es: ', CONVERT(v_contrasena USING utf8)) AS Mensaje;
    ELSE
        SELECT 'Correo electrÃ³nico no encontrado' AS Mensaje;
    END IF;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
BEGIN
    ...
    IF contrasena IS NOT NULL THEN
        SELECT CONCAT('La contraseÃ±a para el correo ', p_correo, ' es: ', contrasena )
        AS Mensaje;
    ELSE
        SELECT 'Correo electrÃ³nico no encontrado' AS Mensaje;
    END IF;
...
-- Dump completed on 2025-03-25  7:08:26
